...
public class PracticarPalabrasDificiles extends JFrame {
    ...
    public PracticarPalabrasDificiles(int idEstudiante) {
        this.idEstudiante = idEstudiante;
        initComponents();
        cargarPalabras();
        if (palabras.isEmpty()) {
            JOptionPane.showMessageDialog(this, "No hay palabras marcadas como difíciles.", "Información", JOptionPane.INFORMATION_MESSAGE);
            dispose();
        } else {
    ...
    private void initComponents() {
        setTitle("Practicar Palabras Difíciles");
        setSize(400, 300);
        ...
        lblTitulo = new JLabel("¡Es hora de practicar palabras difíciles!");
    ...
    private void mostrarPalabraAleatoria() {
        if (palabras.isEmpty()) {
            lblPalabra.setText("No hay palabras marcadas como difíciles.");
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            ...
            new PracticarPalabrasDificiles(idEstudiante).setVisible(true);
        });
    }
}
